  ...
  const projectsDetail = [
    {
      ...
      part: [
        ...
        isMobile
          ? "ㆍ ::marker회원가입, 로그인, 비밀번호 재설정, 직장 지역 / 알림 / 사용자 데이터 / \n    메인화면 날씨 정보 설정화면, 메인화면, 레포트 화면 구현 및 API 연결"
      ...
      feeling: [
        ...
        isMobile
          ...
          : "ㆍ 카카오 로그인 및 이미지 갤러리 저장과 같은 기능을 구현하며, OS의 요구 사항에 맞춰 \n    구현하는 과정에서 많은 시행착오와 학습이 필요했습니다. 플랫폼별 제약 사항을 고려하여 구현하는 데 어려움을 겪었지만,\n    OS의 세부적인 부분까지 신중하게 접근하는 것이 중요하다는 것을 깨달았습니다.",
      ],
    ...
    },
    {
      ...
      feeling: [
        isMobile
          ...
          : "ㆍ 첫 반응형 웹 구현이라 걱정했지만, 예상보다 수월하게 완성할 수 있었습니다. \n    새로운 기술을 익히고 적용하는 과정에서 자신감을 얻었고,\n    앞으로 더 도전적인 프로젝트에도 능숙하게 적응할 수 있다는 확신이 생겼습니다.",
        isMobile
          ...
          : "ㆍ 초기 구현 단계부터 TypeScript를 적용하며 이전 사용 방식의 문제점을 인지할 수 있었습니다. \n    올바른 방법으로 TypeScript를 활용하고, 에러를 해결하는 과정을 거치면서 더욱 익숙해졌으며,\n    효율성과 유용함을 직접 체감할 수 있었습니다.",
      ],
